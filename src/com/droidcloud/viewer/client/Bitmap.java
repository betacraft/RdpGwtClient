...
//	protected static Logger logger = Logger.getLogger(Rdp.class);
	...
	public Bitmap(int[] data, int width, int height, int x, int y) {
		...
		//System.out.println("RDP.java : Bitmap Constructor: height :" + this.height + "widht :" + this.width);
	 ...
	 */
    public static WrappedImage decompressImgDirect(int width, int height, int size, RdpPacket_Localised data, int Bpp, int left, int top, WrappedImage w, Options option) throws RdesktopException {
     ...
     * @throws RdesktopException
     */
    public static ImageData decompressImg(int width, int height, int size, RdpPacket_Localised data, int Bpp,  Options option) throws RdesktopException {
        ...
        boolean insertmix = false, bicolor = false, isfillormix = false;
        w = new WrappedImage(width, height);
/*        if(cm == null)
