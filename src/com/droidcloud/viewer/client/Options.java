...
public class Options {
	...
	private boolean low_latency = false; // disables bandwidth saving tcp packets
	private int keylayout = 0x809; // UK by default
	private String username = "aniket"; // -u username
	private String domain = ""; // -d domain
	private String password = "awati"; // -p password
	private String hostname = ""; // -n hostname
	private String command = "";  // -s command
	private String directory = ""; // -d directory
	private String windowTitle = "DroidCloud Viewer"; // -T windowTitle
	private int width = 320; // -g widthxheight
	private int height = 480; // -g widthxheight
	private int port = 3391; // -t port
	...
	public static boolean paste_hack = false;
	
	private boolean altkey_quiet = false;
	private boolean caps_sends_up_and_down = false;
	private boolean remap_hash = false;
	private boolean useLockingKeyState = false;
	...
	private boolean bitmap_compression = false;
    private boolean persistent_bitmap_caching = true;
    private boolean bitmap_caching = true;       //TODO ask whether speed will increase or not 
    private boolean precache_bitmaps = true;
    private boolean polygon_ellipse_orders = true;
	private boolean sendmotion = false;
	private boolean orders = true;
	private boolean encryption = true;
	private boolean packet_encryption = false;
	private boolean desktop_save = false;
	private boolean grab_keyboard = false;
	private boolean hide_decorations = false;
	private boolean console_session = false;
	private boolean owncolmap = true;

	private boolean use_ssl = false;
	private boolean map_clipboard = false;
...
//    private DirectColorModel colour_model = new DirectColorModel(16,0xFF00,0x0FF0,0x00FF);
    ...
    public void setBPPImpl(int server_bpp){
        ...
        else setColourDepthCorrectionMaskPerBytes(0x00FFFF);
//        setColourModel(new DirectColorModel(16,0xFF00,0x0FF0,0x00FF));
	}
    ...
    public void reset_applet_params(){
		if (Common.underApplet) {
            ...
            setServerDisplayColourDepthBits(16);
        }
	}
