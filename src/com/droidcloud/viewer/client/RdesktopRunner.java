        ...
        try {
         ...
         //       logger.info("Connection successful");
                ...
                if (deactivated[0] ||
                    ...
                    Common.rdp.sendInput(Input.getTime(), Input.RDP_INPUT_MOUSE, Input.MOUSE_FLAG_MOVE, 0,0);
                    return;
                }
...
//            reportError(msg);
    ...
    public static class RdesktopCanvasRunner extends RdesktopRunner {
        ...
        public RdesktopCanvasRunner( Options option, RdesktopCanvas_Localised canvas) {
            super();
            this.canvas = canvas;
            this.option = option;
//            initApplet(canvas);
