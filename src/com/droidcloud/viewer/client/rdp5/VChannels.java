...
import com.droidcloud.viewer.client.MCS;
import com.droidcloud.viewer.client.Options;
import com.droidcloud.viewer.client.RdesktopException;
import com.droidcloud.viewer.client.RdpPacket_Localised;
...
//                    + MCS.MCS_GLOBAL_CHANNEL + num_channels);
     ...
     */
    static Object arrayExpand(byte[] a, int amount) {
/*        Class cl = a.getClass();
        if (!cl.isArray())
            return null;*/
        int length = a.length;
